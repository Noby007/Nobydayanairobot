...
if ENV:
    ...
    from NobyRobot.config import Development as Config
...
telegraph = Telegraph()
print("[NobyRobot]: Telegraph Account Creating")
...
print("[NobyRobot]: TELETHON CLIENT STARTING")
...
# ------------------------------------------------------------------
print("[NobyRobot]: PYROGRAM CLIENT STARTING")
