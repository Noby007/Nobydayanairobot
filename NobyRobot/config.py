...
def get_user_list(config, key):
    with open(f"{os.getcwd()}/NobyRobot/{config}", "r") as json_file:
...
class Config(object):
    ...
    INFOPIC = True
    URL = None
    SPAMWATCH_API = "iGGXTdy7KoLRQZxxyumzrvFnxk1qPA9W~I87nX4UtS5gBqW8Yb~NDOfP6n90aFb6"  # go to support.spamwat.ch to get key
