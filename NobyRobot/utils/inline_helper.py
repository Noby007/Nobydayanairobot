...
from NobyRobot import OWNER_ID, arq, pgram
from NobyRobot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from NobyRobot.utils.pluginhelpers import fetch
