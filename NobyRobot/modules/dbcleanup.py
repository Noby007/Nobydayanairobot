...
import NobyRobot.modules.sql.global_bans_sql as gban_sql
import NobyRobot.modules.sql.users_sql as user_sql
from NobyRobot import DEV_USERS, NEKO_PTB, OWNER_ID
