...
import NobyRobot.modules.sql.userinfo_sql as sql
from NobyRobot import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
    INFOPIC,
...
from NobyRobot.__main__ import STATS, TOKEN, USER_INFO
from NobyRobot.modules.disable import DisableAbleCommandHandler
from NobyRobot.modules.helper_funcs.chat_status import sudo_plus
from NobyRobot.modules.helper_funcs.extraction import extract_user
from NobyRobot.modules.sql.afk_sql import check_afk_status, is_afk
from NobyRobot.modules.sql.global_bans_sql import is_user_gbanned
from NobyRobot.modules.sql.users_sql import get_user_num_chats
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Repo", url="github.com/Awesome-Prince/NobyRobot-3"
                        )
                    ]
                ]
            ),
